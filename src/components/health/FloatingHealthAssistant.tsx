          ...
          >
            ...
            {!shouldReduceMotion && (
              <motion.div
                ...
                className="absolute -inset-2 rounded-full bg-linear-to-r from-indigo-500 via-purple-500 to-cyan-400 blur-md -z-10 pointer-events-none"
              />
            )}
            ...
            >
              ...
              <div className="absolute top-1 inset-x-2.5 h-3.5 rounded-full bg-linear-to-b from-white/60 to-transparent blur-[0.6px] pointer-events-none" />
              ...
              <div className="relative flex items-center justify-center z-10 text-white">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1.5 -inset-x-1 flex items-center justify-center opacity-90">
