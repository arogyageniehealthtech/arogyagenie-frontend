...
import { Search, MapPin, X, Loader2, Microscope, Eye } from 'lucide-react'; 
import { useAppSelector } from '../../../store/hooks'; 
import CustomSelect from '../components/common/CustomSelect';
import MapContainer from '../components/common/MapContainer';
import LabCard from '../components/features/LabCard';
import BookLabModal from '../components/features/BookLabModal';
        ...
        <main className="flex-1 max-w-7xl mx-auto w-full px-1.5 md:px-3 py-1.5 md:py-3 flex flex-col gap-2.5">
          ...
          <section className="relative z-25 w-full bg-white px-3 py-2.5 rounded-2xl shadow-sm border border-slate-200/80 flex flex-col gap-2.5 transition-all">
            ...
            <div className="flex flex-row gap-2 items-center">
              ...
              <div className="relative z-50 w-[110px] sm:w-[140px] md:w-52 h-9 md:h-10 flex-shrink-0 text-xs">
                <CustomSelect 
            ...
            <button 
                                      ...
                                      disabled={isLocating}
                                      className="flex-shrink-0 h-10 md:h-11 px-3.5 md:px-5 flex items-center justify-center gap-1.5 rounded-2xl font-bold transition-all text-xs bg-gradient-to-r from-[#5B21B6] to-indigo-600 text-white shadow-md hover:from-[#4c1d95] hover:to-indigo-700 active:scale-95 disabled:opacity-70"
          ...
          <div className="flex flex-col lg:flex-row gap-3 items-start w-full relative pt-1">
            ...
            {/* Map column */}
            <div className="w-full lg:flex-1 lg:sticky lg:top-[90px] z-10 rounded-2xl overflow-hidden shadow-sm border border-slate-200 h-[260px] sm:h-[320px] lg:h-[calc(100vh-140px)] lg:max-h-[600px]">
              <MapContainer 
