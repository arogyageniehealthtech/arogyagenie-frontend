...
export default function PatientOrderPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 px-3 sm:px-6 py-4 font-sans bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/40 min-h-screen">
      
      {/* ================= QUICK SELECT & REQUEST MEDICINES CARD ================= */}
      <div className="bg-blue-50/40  backdrop-blur-md border-1 border-blue-900 p-4 sm:p-6 rounded-3xl shadow-[0_10px_30px_rgba(91,33,182,0.06)] space-y-4">
