...
const ROLES: { type: BackendUserType; label: string; description: string; icon: React.ElementType }[] = [
  ...
  },
  {
    ...
    description: "Hospital workspace",
    icon: Building2,
  },
];
    ...
    >
      <div className="space-y-4">
            ...
            {ROLES.map(({ type, label, description, icon: Icon }) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center justify-between p-2.5 rounded-xl text-left border transition-all duration-200 cursor-pointer ${
                    isSelected
                ...
                >
                  {isSelected && (
                    <span className="absolute top-1.5 right-1.5 h-3.5 w-3.5 rounded-full bg-indigo-500 flex items-center justify-center text-white">
                      <Check className="h-2.5 w-2.5 stroke-[3]" />
                    </span>
                  )}
                  <Icon className={`h-5 w-5 mb-1.5 ${isSelected ? "text-indigo-400" : "text-slate-400"}`} />
        ...
        {(error || validationError) && (
          <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/20 flex items-start gap-2 text-red-300 text-xs animate-fadeIn">
        ...
        <div className="flex items-center gap-3 my-2">
          ...
          <span className="text-[10px] uppercase tracking-widest text-slate-400 font-medium">Or email</span>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-white/15 to-transparent" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-white/10 bg-slate-900/40 text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-9 pr-9 py-2.5 rounded-xl border border-white/10 bg-slate-900/40 text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full pl-9 pr-3 py-2.5 rounded-xl border bg-slate-900/40 text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none transition-all ${
          ...
          <div className="flex items-start gap-2.5 pt-1">
            <input
              ...
              className="h-4 w-4 mt-0.5 rounded border-white/20 bg-slate-900/60 text-indigo-600 accent-indigo-600 cursor-pointer focus:ring-0"
            />
