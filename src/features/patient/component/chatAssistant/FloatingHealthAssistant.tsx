      ...
      <AnimatePresence>
        { (
          <motion.div
            ...
            className="fixed inset-0 sm:inset-auto sm:bottom-16 sm:right-6 sm:left-auto z-50 w-full sm:w-155 md:w-205 lg:w-247.5 xl:w-270 max-w-none sm:max-w-[calc(100vw-2rem)] h-dvh sm:h-170 lg:h-185 max-h-none sm:max-h-[calc(100vh-5rem)] bg-[#060819] rounded-none sm:rounded-[32px] overflow-hidden flex flex-col border-0 sm:border sm:border-indigo-500/40"
            style={{
              boxShadow:
