        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-sm border border-slate-200/90 p-1.5 sm:p-2 flex flex-col md:flex-row items-stretch md:items-center gap-1.5 transition-all">
          ...
          <div className="flex items-center gap-1.5 flex-1 min-w-0">
            ...
            <div className="relative flex-1 h-8 sm:h-9 min-w-0">
              ...
              <input 
                type="text" 
                placeholder="Search diagnostic labs, blood tests..." 
          ...
          {/* Bottom Row on Mobile / Inline on Desktop: Test Filter + Upload Rx + Radius Step Control */}
          <div className="flex items-center gap-1.5 shrink-0 flex-wrap sm:flex-nowrap">
            {/* Test Type Filter */}
            <div className="flex-1 min-w-32 md:w-44 h-8 sm:h-9">
              <CustomSelect 
            ...
            <button
              ...
              className="h-8 sm:h-9 px-2 sm:px-2.5 bg-purple-50 hover:bg-purple-100 text-[#5B21B6] rounded-xl border border-purple-200 text-[11px] sm:text-xs font-bold flex items-center justify-center gap-1 transition-all shrink-0 cursor-pointer shadow-2xs"
              title="Upload Doctor's Prescription"
            >
              <UploadCloud className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
              <span className="truncate">{prescriptionUrl ? 'Rx Attached' : 'Upload Rx'}</span>
            </button>
